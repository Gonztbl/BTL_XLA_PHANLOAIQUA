...
graph TD
    subgraph "Giai đoạn 1: Giao diện & Nhập liệu"
        A[Người dùng tải ảnh lên qua Giao diện Web (Flask)] --> B{app_py nhận yêu cầu};
    end

    subgraph "Giai đoạn 2: Phát hiện Đối tượng (YOLOv8n)"
        B --> C[Tải mô hình YOLOv8n<br/>(yolo11n_pt)];
